...
<head>
    ...
    <title>Multi-Step Form - Company Profile</title>
    ...
    <style>
        ...
        .stepper-item {
            ...
            position: relative;
            z-index: 1;
            flex-grow: 1; /* Allow items to grow and push lines */
            cursor: pointer; /* Make stepper items clickable */
        }

        .stepper-icon-container { /* New container for icon and background */
        ...
        .stepper-item.active .stepper-icon-container {
            ...
            border-color: #6f42c1; /* Active border */
        }
        ...
        .stepper-item.active .stepper-label {
            color: #6f42c1; /* Purple */
            font-weight: 600; /* More prominent active label */
        }

        .stepper-line {
            position: absolute;
            width: calc(100% - 30%); /* Adjusted width to fit between icons */
            height: 2px;
            background-color: #dee2e6; /* Lighter line color */
            top: 27px; /* Half of icon height + border */
            left: 15%; /* Start from the edge of the first item's padding */
            z-index: 0;
        ...
        .stepper-item.completed .stepper-label {
            color: #495057; /* Keep label color for completed */
        }
        .stepper-item.completed .stepper-sublabel {
            color: #6c757d; /* Keep sublabel color for completed */
        }
        ...
        @media (max-width: 768px) {
            ...
            .stepper-item {
                ...
                width: 30%; /* Approximate width for each item on small screens */
            }
            .stepper-line {
                display: none; /* Hide line on small screens for cleaner layout */
            }
        }
        ...
        .form-control:focus, .form-select:focus {
            border-color: #8c72cf; /* Purple border on focus */
            box-shadow: 0 0 0 0.25rem rgba(111, 66, 193, 0.2); /* Purple shadow on focus */
            outline: none;
        }
        ...
        .form-control.is-invalid, .form-select.is-invalid {
            ...
            box-shadow: 0 0 0 0.25rem rgba(220, 53, 69, 0.2); /* Red shadow on invalid */
        ...
        .invalid-feedback {
            color: #dc3545; /* Red text for feedback */
            font-size: 0.85em;
            margin-top: 0.5rem; /* More space for feedback */
        ...
        .input-group .btn-outline-secondary {
            border-top-right-radius: 10px; /* Match input border-radius */
            border-bottom-right-radius: 10px;
            border-left: 1px solid #e0e0e0; /* Match input border */
            border-color: #e0e0e0;
            color: #6c757d;
        ...
        .btn-primary:hover {
            background-color: #5a36a3; /* Darker purple */
            border-color: #5a36a3;
        ...
        .plan-card-wrapper .plan-content:hover {
            border-color: #8c72cf; /* Purple border on hover */
            box-shadow: 0 4px 15px rgba(111, 66, 193, 0.15); /* More pronounced shadow on hover */
            transform: translateY(-3px); /* Slight lift on hover */
        }

        .plan-card-wrapper input[type="radio"]:checked + .plan-content {
            border-color: #6f42c1; /* Purple border when checked */
            box-shadow: 0 5px 20px rgba(111, 66, 193, 0.25); /* Stronger shadow when checked */
            background-color: #f7f3fd; /* Very light purple background when active */
            transform: translateY(-3px); /* Stay lifted when active */
        }

        .plan-card-wrapper .plan-content .card-title {
            color: #6f42c1; /* Purple title */
            font-weight: 600;
            margin-bottom: 5px;
        }
...
<body>
    ...
    <div class="container my-5">
        <div class="card shadow-lg p-md-5 p-3">
            <!-- Header Section -->
            <div class="d-flex flex-column flex-sm-row align-items-center justify-content-between mb-5 pb-4 border-bottom border-gray-200">
                <!-- Logo and Title -->
                <div class="d-flex flex-column flex-sm-row align-items-center space-y-4 space-sm-y-0 space-sm-x-3 mb-4 mb-sm-0">
                    <div class="logo-upload-container me-3" id="logo-upload-area">
                        <img id="logo-preview" src="" alt="Company Logo" class="w-100 h-100 object-cover rounded-circle">
                        <span id="logo-placeholder-text" class="logo-upload-text">Upload Logo</span>
                    ...
                    <div class="d-flex flex-column align-items-center align-items-sm-start text-center text-sm-start">
                        <h1 class="h3 font-weight-bold text-gray-800">Company Profile</h1>
                        <p class="h5 text-muted mt-1">Facturación Electrónica</p>
                    </div>
                </div>
                <p class="text-muted text-center text-sm-end">Manage your company's information</p>
            </div>
