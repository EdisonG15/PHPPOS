         ...
         <div class="row">
             ...
             <div class="col-lg-2">
                 ...
                 <div class="small-box bg-info">
                     ...
                     <a style="cursor:pointer;"  onclick="CargarContenido('Views/modulos/Gestion/Producto/productos.php','content-wrapper')" class="small-box-footer">Mas Info <i class="fas fa-arrow-circle-right"></i></a>
                 </div>
             </div>
             ...
             <div class="col-lg-2">
                 ...
                 <div class="small-box bg-success">
                     <div class="inner">
                         <h4 id="totalcomprasInventario">$./ 0,000.00</h4>
             ...
             <div class="col-lg-2">
                 ...
                 <div class="small-box bg-primary">
                     <div class="inner">
                         <h4 id="Total_compras_realizada">$./ 0,000.00</h4>
                     ...
                     <a style="cursor:pointer;" onclick="CargarContenido('Views/modulos/Compras/Administrar_compras/historial_de_compras.php','content-wrapper')" class="small-box-footer">Mas Info <i class="fas fa-arrow-circle-right"></i></a>
                 </div>
             </div>
...
<!-- 
             ...
             <div class="col-lg-2">
                 ...
                 <div class="small-box bg-danger">
                     <div class="inner">
                         <h4 id="totalGanancias">$./ 0,000.00</h4>
                     ...
                     <a style="cursor:pointer;" onclick="CargarContenido('Views/modulos/Reportes/ganacias.php','content-wrapper')" class="small-box-footer">Mas Info <i class="fas fa-arrow-circle-right"></i></a>
                 </div>
             </div>
             ...
             <div class="col-lg-2">
                 ...
                 <div class="small-box bg-secondary">
                     <div class="inner">
                         <h4 id="totalVentasHoy">$./ 0,000.00</h4>
                     ...
                     <a style="cursor:pointer;"  onclick="CargarContenido('Views/modulos/Reportes/ventas_hoy.php','content-wrapper')" class="small-box-footer">Mas Info <i class="fas fa-arrow-circle-right"></i></a>
                 </div>
             </div>
         ...
         setInterval(() => {
            $.ajax({
                ...
                console.log(respuesta);
                    ...
                    $("#totalcomprasInventario").html(respuesta[0]['totalComprasInventario'])
                    ...
                    $("#Total_compras_realizada").html(respuesta[0]['totalCompraRealizada'])
